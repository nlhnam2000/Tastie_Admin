...
export { default as BackdropUnstyled } from '@mui/base/BackdropUnstyled';
export * from '@mui/base/BackdropUnstyled';
...
export { default as Unstable_TrapFocus } from '@mui/base/Unstable_TrapFocus';
