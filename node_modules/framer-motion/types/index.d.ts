...
export { addScaleCorrection } from "framer-motion/types/render/dom/projection/scale-correction";
export { snapshotViewportBox } from "framer-motion/types/render/dom/projection/utils";
export { createCrossfader } from "framer-motion/types/components/AnimateSharedLayout/utils/crossfader";
export { visualElement } from "framer-motion/types/render";
export { VisualElement } from "framer-motion/types/render/types";
export { batchLayout, flushLayout } from "framer-motion/types/render/dom/utils/batch-layout";
/**
 * Contexts
 */
...
export { SharedLayoutAnimationConfig, VisibilityAction, SharedLayoutSyncMethods, SyncLayoutLifecycles, } from "framer-motion/types/components/AnimateSharedLayout/types";
export { SharedLayoutContext, FramerTreeLayoutContext, } from "framer-motion/types/context/SharedLayoutContext";
export { createBatcher } from "framer-motion/types/components/AnimateSharedLayout/utils/batcher";
